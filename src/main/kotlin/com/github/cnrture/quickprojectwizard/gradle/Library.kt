...
sealed class Library(val libName: String, val group: String, val name: String, val verRef: String? = null) {
    ...
    data object JunitVersion : Library("junitVersion", "androidx.test.ext", "junit", "junitVersion")
    ...
    data object GlideCompose : Library("glide-compose", "com.github.bumptech.glide", "compose", "glideVersion")
